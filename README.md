...
# LOS SIGUIENTES PASOS SON PARA USUARIO DESARROLADOR, QUE DESEA APRENDER, Y NO SOLO INSTALAR Y USAR EL SERVIDOR
...
- ```bash
  ...
  Si solo vas a usar tu imagen de Docker en forma local, saltea este paso!
